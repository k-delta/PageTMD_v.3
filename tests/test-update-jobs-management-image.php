...
tmd_jobs_management_test_assert(true === tmd_jobs_management_attached_file_matches('2026/09/gerencia-scaled-e1787869020907.webp'), 'Debe aceptar el basename exacto en una ruta de uploads.');
tmd_jobs_management_test_assert(false === tmd_jobs_management_attached_file_matches('2026/09/gerencia-scaled-e1787869020907-1.webp'), 'No debe aceptar un archivo numerado parecido.');
tmd_jobs_management_test_assert(false === tmd_jobs_management_attached_file_matches('2026/09/gerencia.webp'), 'No debe aceptar otro archivo gerencia.');
...
tmd_jobs_management_test_assert('gerencia-scaled-e1787869020907.webp' === $target_filename, 'Debe fijar el nombre exacto del attachment solicitado.');
